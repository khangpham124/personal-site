...
const ProfileLayout = ()=>{
    ...
    const serviceDocumentAPI = new _services_documentService__WEBPACK_IMPORTED_MODULE_3__/* .documentAPI */ .a();
    const t = (0,next_intl__WEBPACK_IMPORTED_MODULE_1__.useTranslations)("Shopping_Cart");
    const { 0: profileCustomer , 1: setProfileCustomer  } = (0,react__WEBPACK_IMPORTED_MODULE_2__.useState)();
    const { 0: ordesCustomer , 1: setOrdesCustomer  } = (0,react__WEBPACK_IMPORTED_MODULE_2__.useState)();
    const { 0: wishListCustomer , 1: setWishListCustomer  } = (0,react__WEBPACK_IMPORTED_MODULE_2__.useState)();
    const { 0: firstName , 1: setFirstName  } = (0,react__WEBPACK_IMPORTED_MODULE_2__.useState)("");
    const { 0: lastName , 1: setLastName  } = (0,react__WEBPACK_IMPORTED_MODULE_2__.useState)("");
    const { 0: fullName , 1: setFullName  } = (0,react__WEBPACK_IMPORTED_MODULE_2__.useState)("");
    const { 0: email , 1: setEmail  } = (0,react__WEBPACK_IMPORTED_MODULE_2__.useState)("");
    const { 0: phone , 1: setPhone  } = (0,react__WEBPACK_IMPORTED_MODULE_2__.useState)("");
                ...
                /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
                    ...
                    children: [
                        /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("p", {
                            children: "I work as a freelance web developer in Ho Chi Minh City, Vietnam, I've also worked remotely with clients in Italy, Thailand, Australia, Japan, and other countries with a variety of projects including EC, corporate websites, high-load services, and portals... I’ve had over 8 years of experience creating high-quality web design and development. My engineering skills-set is dynamic and constantly evolves to match the most recent trends so I can refine my process to make the process of making a website easier for you. More than that, I can help you unlock the value of your idea and solve your development challenges by delivering best-in-class creative strategy, user experience, and visual design on a website that results in a solution that meets the needs of your business within budget and on time."
                        }),
