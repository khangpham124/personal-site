      ...
      <div id="teddy_slide">
        ...
        >
          <div key={`slide_1`} className="warpText--wrap">
            <img
              src={`http://teddycoder.click/assets/img/top/coder1.jpg`}
              alt="Our Shop"
            />
          ...
          <div key={`slide_1`} className="warpText--wrap">
            <img
              src={`http://teddycoder.click/assets/img/top/coder3.jpg`}
              alt="Our Shop"
            />
            <div className="warpText">
              <div className="mb-4">
          ...
          <div key={`slide_1`} className="warpText--wrap">
            <img
              src={`http://teddycoder.click/assets/img/top/coder2.jpg`}
              alt="Our Shop"
            />
            <div className="warpText">
              <div className="mb-4">
