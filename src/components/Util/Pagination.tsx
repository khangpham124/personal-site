...
import NextArrow from '@/public/assets/icons/NextArrow';
import PrevArrow from '@/public/assets/icons/PrevArrow';
      ...
      <ul className="flex justify-center">
        <li>
          <button
            ...
            onClick={() =>
              router.push(
                `/product-category/${category}?page=${currentPage - 1}&orderby=${orderby}`
              )
            }
            className={`${
              currentPage === 1
          ...
          return (
            <li key={num} className="">
              <button
                type="button"
                onClick={() =>
                  router.push(`/product-category/${category}?page=${num}&orderby=${orderby}`)
                }
                className={`${
