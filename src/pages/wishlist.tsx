  ...
  return (
    <div>
      ...
      <main id="main-content">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-8 md:px-20 w-full border-t-2 border-gray100">
        ...
        {/* <div className="max-w-7xl mx-auto px-4 sm:px-8 md:px-20 mb-14 flex flex-col lg:flex-row">
          <div className="h-full w-full">
            <table className="w-full mb-6">
              <thead>
                <tr className="border-t-2 border-b-2 border-gray200">
                  ...
                  <th className="font-normal hidden sm:table-cell py-2 max-w-xs">{t('add')}</th>
            ...
            <div>
              <GhostButton onClick={clearWishlist} extraClass="w-full sm:w-48 whitespace-nowrap">
                {t('clear_wishlist')}
              </GhostButton>
            </div>
          </div>
