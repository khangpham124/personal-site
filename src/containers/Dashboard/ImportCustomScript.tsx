...
export default function ImportCustomScript() {
  useScript("/theme/js/perfect-scrollbar.jquery.min.js");
  useScript("/theme/js/waves.js");
  useScript("https://cdnjs.cloudflare.com/ajax/libs/axios/0.21.4/axios.min.js");
  ...
  useScript("/theme/js/set-image.js");
  useScript("/theme/js/custom.js");
  useScript("/theme/js/react.production.min.js");
  // useScript("/theme/js/react-collapse.min.js");
  return <></>;
}
